//ayuda a eminem a recolectar frutas
var PLAY=1;
var END=0;
var gameState=1;
...
var yiSound , fuaSound;
function preload(){
  
  knifeImage = loadImage("u.png");
  monsterImage = loadAnimation("francais.png","spain.png")
  ...
  yiSound = loadSound(":v.mp3")
  fuaSound = loadSound("sus.mp3")
